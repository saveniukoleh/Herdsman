...
function _getGlobalBoundsRecursive(target, bounds) {
  ...
  if (manageEffects) {
    ...
    if (advanced) {
      localBounds.applyMatrix(target.renderGroup.worldTransform.copyTo(tempMatrix2).invert());
...
//# sourceMappingURL=chunk-6GSTQFXJ.js.map
